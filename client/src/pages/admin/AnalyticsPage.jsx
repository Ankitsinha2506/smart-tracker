...
export function AnalyticsPage() {
  ...
  const cardItems = [
    ...
    ['Total Placed Students', cards.placedStudents, <Stars key="placed" />, 'success.main'],
    ['Inactive Candidates', Math.max(0, (cards.totalStudents || 0) - (cards.activeStudents || 0) - (cards.placedStudents || 0)), <Person key="inactive" />, 'warning.main'],
    ...
    ["This Month's Applications", cards.monthlyApplications, <CalendarMonth key="monthly" />, 'secondary.main'],
